...
@objc(Goapptivimagemodule)
class Goapptivimagemodule: NSObject {
...
extension Goapptivimagemodule: ImageScannerControllerDelegate {
...
extension Goapptivimagemodule: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
